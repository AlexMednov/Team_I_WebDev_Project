...
<html>
	...
	<body>
		<div id="container">
			<p class="button1"><a class="link" href="../../php_files/map_page.php"><</a></p>
			<p class="contact">Contact us</p>
			<div id="box">
				<div class="paragraph1">
					<p class="title">You could mail us using this</p>
					<p class="text">adress.</p>
					<b><p class="text">place.holder@gmail.com</p></b>
				...
				<div class="paragraph2">
					...
					<b><p class="text">0123 5678 89 01</p></b>
				</div>
			</div>
			<div id="logo">
			...
			<div id="button">
				<h2><a class="link2" href="../../php_files/map_page.php">Back</a></h2>
			</div>
